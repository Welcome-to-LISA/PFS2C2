...
### common parameters
parser.add_argument('--scale_factor', type=int,default=4, help='scale_factor, set to 5 and 8 in our experiment')
...
parser.add_argument('--data_name',type=str, default="paviau",help='name of your data and spectral response. houston18 is given as a example')
...
parser.add_argument('--checkpoints_dir',type=str, default='checkpoints123',help='where store the training results')
###
...
parser.add_argument("--epoch_stage3", type=int, default=30000, help='total epoch')
parser.add_argument("--decay_begin_epoch_stage3", type=int, default=20000, help='epoch which begins to decay,so the lr is 6e-5 in the first 5000 epochs and then it decays from 5000th epoch to 15000th epoch. When 15000 epochs are finished, the lr decays to 0')
###
